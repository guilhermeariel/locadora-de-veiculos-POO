...
public class TesteAluguel {
    public static void main(String[] args) {
        ...
        Veiculo veiculo2 = new Veiculo("XYZ5678", TipoVeiculo.SEDAN, "Honda Civic", true);
        Veiculo veiculo3 = new Veiculo("ELE1234", TipoVeiculo.SEDAN, "Tesla Model 3", true);
        ...
        // Criar aluguéis
        Aluguel aluguel1 = new Aluguel(cliente1, veiculo1, LocalDateTime.now(), LocalDateTime.now().plusDays(5));
